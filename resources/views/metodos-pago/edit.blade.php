        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('metodos-pago.update', $metodoPago) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <select name="nombre_metodo" 
                                ...
                                <option value="tarjeta_credito" {{ old('nombre_metodo', $metodoPago->nombre_metodo) == 'tarjeta_credito' ? 'selected' : '' }}>
                                    Tarjeta de Crédito
                                </option>
                                <option value="efectivo" {{ old('nombre_metodo', $metodoPago->nombre_metodo) == 'efectivo' ? 'selected' : '' }}>
                                    Efectivo
                                </option>
                                <option value="transferencia_bancaria" {{ old('nombre_metodo', $metodoPago->nombre_metodo) == 'transferencia_bancaria' ? 'selected' : '' }}>
